...
class DeliveriesController extends AppController
{
    ...
    protected function setCustomFormOptions()
    {
        ...
        $this->renderOptions['products_panel'] = $this->genPanel($pns, [
            ...
            'toolbars' => [
                $this->genFilterbar($pns, 'deliveries_form')
            ],
            'table' => $this->genTable($pns, 'delivery', [
                // 'actions' => true,
                'export' => true,
                'd' => [
                    'ajax' => [
        ...
        $this->addModal([
            'title' => $this->genTranslateText('to_delivery', 'modal.title', $ons),
            'name' => 'orders_import',
            'en' => $ons['name'],
            'ecn' => $ons['className'],
            'fieldtype' => 'ajson',
            ...
            'toolbars' => [
                $this->genFilterbar($ons, 'deliveries_form')
            ],
            'buttons' => [
                'add' => [
                    'block' => 'btn_add',
            ...
            'table' => $this->genTable($ons, 'to_delivery', [
                'd' => [
                    'ajax' => [
